...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://shonenbuilds.online",
    },//canonical added 
    ...
    twitter: {
        ...
        title: "ShonenBuilds — Gamified Calisthenics App",
        description: "Master Planche, Front Lever, and Human Flag with gamified skill trees and XP ranks.",
        images: ["/og-image.png"],
        creator: "@shonenbuilds",
    },
...
const jsonLd = {
    ...
    "@graph": [
        ...
        },
        {
            ...
            audience: {
                "@type": "Audience",
                audienceType: "Calisthenics athletes, bodyweight fitness enthusiasts, anime fans",
            },
            publisher: { "@id": "https://shonenbuilds.online/#organization" },
        },
    ],
