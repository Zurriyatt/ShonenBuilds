        ...
        <div className="w-full max-w-4xl mx-auto px-8">
            <div className="flex items-center gap-4 mb-2">
                ...
                <div className="flex-1 relative overflow-hidden h-2 rounded-full bg-border">
                    ...
                    >
                        <div
                            className="absolute top-0 bottom-0 w-[40%] bg-gradient-to-r from-transparent via-foreground/25 to-transparent"
                            style={{
            ...
            <div className="flex flex-col gap-3 p-1">
                ...
                <div className="bg-secondary rounded-lg px-2.5 py-2">
                    ...
                    {[
                        ...
                        >
                            <span className="text-[10px] text-foreground/60 font-body">{a.text}</span>
                            <div className="flex gap-2">
        ...
        content: (
            <div className="flex flex-col gap-2 p-1">
                ...
                <div className="rounded-lg bg-secondary px-2.5 py-1.5 flex justify-between items-center">
                    <span className="text-[10px] text-foreground/70 font-body">Upper Body Mastery Path</span>
                    ...
                    >
                        ...
                        <span
                            className={`flex-1 text-[10px] font-body ${
                                r.self ? "text-foreground font-semibold" : "text-foreground/60"
                            }`}
                        >
                            {r.name}
                        </span>
    ...
    return (
        <div className="min-h-screen max-w-screen font-body overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6  pb-20 overflow-hidden">
                ...
                {/* Headline */}
                <h1 className="fade-up-2 font-display font-bold text-[clamp(56px,8vw,96px)] leading-none tracking-[-0.04em] text-foreground mb-6 z-[1] max-w-[800px]">
                    Level Up.{" "}
                ...
                {/* Subtext */}
                <p className="fade-up-3 font-body font-light text-[clamp(16px,2vw,20px)] text-foreground/55 max-w-[520px] text-xs leading-[1.65] mb-10 z-1">
                    Master calisthenics. Choose your discipline — build bodyweight control as a Shinobi, unlock
                    explosive S-Rank strength as an Awakened Hunter, forge unbreakable core endurance on the High Seas,
                    or develop pure mind-muscle mastery as a Spirit Warrior. Every rep earns XP. Break your limits and
                    climb 10 tiers of power.
                </p>
                ...
                <div className="fade-up-4 mt-10 z-[1] flex items-center gap-3">
                    ...
                    <span className="text-[13px] text-muted-foreground">
                        <strong className="text-foreground">8,421</strong> warriors training right now
                    </span>
                </div>
            </section>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-4 pt-3.5 pb-3 border-b border-border">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-display font-bold text-[13px] text-foreground/85 tracking-[-0.01em]">
                                        {card.label}
                                    </span>
                                </div>
                                <span
            ...
            <footer className="border-t border-border px-12 py-8 flex items-center justify-between max-w-[1200px] mx-auto">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-display font-bold text-[13px] text-foreground/40">ShonenBuilds</span>
                </div>
                ...
                <div className="flex gap-6">
                    {["Privacy", "Terms", "Status", "Contact"].map((l) => (
                        <a
                            key={l}
                            href="#"
                            className="text-xs text-muted-foreground font-body no-underline transition-colors duration-200 hover:text-foreground"
                        >
                            {l}
                        </a>
                    ))}
